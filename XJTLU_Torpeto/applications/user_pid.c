...
//比赛模式下摩擦轮电机1PID参数和PID结构体
fp32 C_ShootMotor1PID[3] = {ShootMOTOR1_SPEED_PID_KP, ShootMOTOR1_SPEED_PID_KI, ShootMOTOR1_SPEED_PID_KD};
pid_type_def C_ShootMotor1;

//比赛模式下摩擦轮电机2PID参数和PID结构体
fp32 C_ShootMotor2PID[3] = {ShootMOTOR1_SPEED_PID_KP, ShootMOTOR1_SPEED_PID_KI, ShootMOTOR1_SPEED_PID_KD};
pid_type_def C_ShootMotor2;
...
void user_pid_Init(void)
{
	...
	PID_init(&C_ShootMotor1, PID_POSITION, C_ShootMotor1PID, ShootMOTOR1_SPEED_PID_MAX_OUT, ShootMOTOR1_SPEED_PID_MAX_IOUT);
	PID_init(&C_ShootMotor2, PID_POSITION, C_ShootMotor2PID, ShootMOTOR1_SPEED_PID_MAX_OUT, ShootMOTOR1_SPEED_PID_MAX_IOUT);
}
...
void user_pid_Calc(void)
{
	...
	PID_calc(&C_ShootMotor1, motor_chassis[0].speed_rpm, -c_shoot_speed_set);
	PID_calc(&C_ShootMotor2, motor_chassis[1].speed_rpm, c_shoot_speed_set);
}
